/**
 * @desc get a record from sessionStorage according by specified key
 * @param {String} key
 * @return {Object} value
 */
const get = key => {
...
/**
 * @desc add a record from sessionStorage according by specified key-value pair
...
/**
 * @desc remove a record from sessionStorage according by specified key
 * @param {String | Number} key
 */
